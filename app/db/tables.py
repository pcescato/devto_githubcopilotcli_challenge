...
comments = Table(
    ...
    Column('article_id', Integer, nullable=False, index=True,
           comment='References article_id (no FK - article_metrics is time-series)'),
...
article_content = Table(
    ...
    Column('article_id', Integer, primary_key=True,
           comment='One content record per article (no FK - article_metrics is time-series)'),
...
milestone_events = Table(
    ...
    Column('article_id', Integer, nullable=True, index=True,
           comment='References article_id (no FK - article_metrics is time-series). NULL for account-level events'),
